...
public class DownstreamCollerctors {
    private static class City{
        ...
        public static void main(String[] args) throws IOException
        {
            ...
            Stream<City> cities = readCities("src/main/java/CJV/v2ch01/cities.txt");
            ...
            cities = readCities("src/main/java/CJV/v2ch01/cities.txt");
